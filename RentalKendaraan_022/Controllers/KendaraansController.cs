...
using RentalKendaraan_022.Models;
...
namespace RentalKendaraan_022.Controllers
{
    public class KendaraansController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdKendaraan,NamaKendaraan,N0Polisi,NoStnk,IdJenisKendaraan,Ketersediaan")] Kendaraan kendaraan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdKendaraan,NamaKendaraan,N0Polisi,NoStnk,IdJenisKendaraan,Ketersediaan")] Kendaraan kendaraan)
        {
